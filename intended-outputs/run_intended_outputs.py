...
# ---------------------------------------------------------------------------
# Stimuli (loaded from data/stimuli/ in the repo root)
# ---------------------------------------------------------------------------
...
CONCEPT_LIST = [
    w.strip().lower()
    for w in (STIMULI_DIR / "concepts.txt").read_text().split(",")
    if w.strip()
]

SENTENCE_LIST = [
    s.strip()
    for s in (STIMULI_DIR / "sentences.txt").read_text().splitlines()
    if s.strip()
]
